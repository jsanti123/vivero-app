            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link mx-lg-3" aria-current="page" href="#">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mx-lg-3" href="#">Fincas</a>
                        </li>
                        <li class="nav-item">
...
<footer class="footer bg-dark text-white">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 mx-2 text-center d-flex justify-content-center align-items-center">
                <p class="slogan">¡Cultivando sueños, sembrando vida!</p>
            </div>
            <div class="col mx-2 text-center d-flex justify-content-center align-items-center flex-column">
                <p class="contacto">Contacto</p>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-xm-6">
                            <a href="">
